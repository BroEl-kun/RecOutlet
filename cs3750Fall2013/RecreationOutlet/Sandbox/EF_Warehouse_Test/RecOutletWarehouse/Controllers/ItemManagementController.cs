...
namespace RecOutletWarehouse.Controllers
{
    public class ItemManagementController : Controller
    {
        ...
        private RecreationEntities entityDb = new RecreationEntities();
        ...
        public ActionResult addNewDeptCatSubcat(ItemDeptCatSubcatViewModel model, string submitButton) {
            ...
            if (submitButton == "Department") {
                ...
                entityDb.Departments.Add(model.department);
                entityDb.SaveChanges();
            ...
            if (submitButton == "Category") {
                ...
                entityDb.Categories.Add(model.category);
                entityDb.SaveChanges();
            ...
            if (submitButton == "Subcategory") {
                ...
                entityDb.SubCategories.Add(model.subcat);
                entityDb.SaveChanges();
        ...
        public ActionResult ViewItemDeptCatSubCat()
        {
            ...
            collection.category = entityDb.Categories.ToList();
            collection.department = entityDb.Departments.ToList();
            collection.subcat = entityDb.SubCategories.ToList();
