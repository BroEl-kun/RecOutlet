...
--ALTER TABLE [dbo].[PAYMENT]  WITH CHECK ADD  CONSTRAINT [FK_PAYMENT_LOCATION] FOREIGN KEY([LocationID])
--REFERENCES [dbo].[LOCATION] ([LocationID])
--GO
...
/****** Object:  Index [PK_TAX_TYPE]    Script Date: 1/15/2014 8:44:26 PM ******/
...
--ALTER TABLE [dbo].[TRANSACTION_LINE_ITEM]  WITH CHECK ADD  CONSTRAINT [FK_TRANSACTION_LINE_ITEM_STORE_TRANSACTION] FOREIGN KEY([TransactionID], [LocationID])
--REFERENCES [dbo].[STORE_TRANSACTION] ([TransactionID], [LocationID])
--GO
...
ALTER TABLE [dbo].[INVENTORY]  WITH CHECK ADD  CONSTRAINT [FK_INVENTORY_QTY_TYPE] FOREIGN KEY([QtyTypeID])
REFERENCES [dbo].[QTY_TYPE] ([QtyTypeID])
GO

ALTER TABLE [dbo].[INVENTORY] CHECK CONSTRAINT [FK_INVENTORY_QTY_TYPE]
GO
...
ALTER TABLE [dbo].[INVOICE_LINEITEM]  WITH CHECK ADD  CONSTRAINT [FK_INVOICE_LINEITEM_QTY_TYPE] FOREIGN KEY([QtyTypeID])
REFERENCES [dbo].[QTY_TYPE] ([QtyTypeID])
GO

ALTER TABLE [dbo].[INVOICE_LINEITEM] CHECK CONSTRAINT [FK_INVOICE_LINEITEM_QTY_TYPE]
GO

ALTER TABLE [dbo].[INVOICE_LINEITEM]  WITH CHECK ADD  CONSTRAINT [FK_INVOICE_LINEITEM_TAX_RATE] FOREIGN KEY([TaxRateID])
REFERENCES [dbo].[TAX_RATE] ([TaxRateID])
GO

ALTER TABLE [dbo].[INVOICE_LINEITEM] CHECK CONSTRAINT [FK_INVOICE_LINEITEM_TAX_RATE]
GO
...
ALTER TABLE [dbo].[ITEM]  WITH CHECK ADD  CONSTRAINT [FK_ITEM_TAX_TYPE] FOREIGN KEY([TaxTypeID])
REFERENCES [dbo].[TAX_TYPE] ([TaxTypeID])
GO

ALTER TABLE [dbo].[ITEM] CHECK CONSTRAINT [FK_ITEM_TAX_TYPE]
GO
...
ALTER TABLE [dbo].[SHIPPING_LOG]  WITH CHECK ADD  CONSTRAINT [FK_SHIPPING_LOG_INVOICE] FOREIGN KEY([InvoiceID])
REFERENCES [dbo].[INVOICE] ([InvoiceID])
GO
...
ALTER TABLE [dbo].[STORE_TRANSACTION]  WITH CHECK ADD  CONSTRAINT [FK_STORE_TRANSACTION_LOCATION] FOREIGN KEY([LocationID])
REFERENCES [dbo].[LOCATION] ([LocationID])
GO
...
/****** Object:  Index [PK_TAX_RATE]    Script Date: 1/17/2014 7:22:31 PM ******/

ALTER TABLE [dbo].[TAX_RATE]  WITH CHECK ADD  CONSTRAINT [FK_TAX_RATE_LOCATION] FOREIGN KEY([LocationID])
REFERENCES [dbo].[LOCATION] ([LocationID])
GO

ALTER TABLE [dbo].[TAX_RATE] CHECK CONSTRAINT [FK_TAX_RATE_LOCATION]
GO

ALTER TABLE [dbo].[TAX_RATE]  WITH CHECK ADD  CONSTRAINT [FK_TAX_RATE_TAX_TYPE] FOREIGN KEY([TaxTypeID])
REFERENCES [dbo].[TAX_TYPE] ([TaxTypeID])
GO

ALTER TABLE [dbo].[TAX_RATE] CHECK CONSTRAINT [FK_TAX_RATE_TAX_TYPE]
GO

/****** Object:  Index [PK_TRANSACTION_LINE_ITEM]    Script Date: 1/17/2014 7:22:31 PM ******/

--ALTER TABLE [dbo].[TRANSACTION_LINEITEM]  WITH CHECK ADD  CONSTRAINT [FK_TRANSACTION_LINEITEM_STORE_TRANSACTION] FOREIGN KEY([TransactionID], [LocationID])
--REFERENCES [dbo].[STORE_TRANSACTION] ([TransactionID], [LocationID])
--GO
