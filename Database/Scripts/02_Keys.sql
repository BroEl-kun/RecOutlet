...
--		  01/22/2015: Chris Parkins - Reorganized into Primary then
--					  Foriegn keys
--
-- *********************************************************************
...
ALTER TABLE [dbo].[TRANSACTION_LINE_ITEM] ADD  CONSTRAINT [PK_TRANSACTION_LINE_ITEM] PRIMARY KEY CLUSTERED 
(
...
ALTER TABLE [dbo].[SALE_PRICING]  WITH CHECK ADD  CONSTRAINT [FK_SALE_PRICING_EVENT_TYPE] FOREIGN KEY([RecRPC])
REFERENCES [dbo].[ITEM] ([RecRPC])
GO
